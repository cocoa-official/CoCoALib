...
DECLARE_COCOALIBFORC5_FUNCTION1(InvTotient, INT) // JAA
DECLARE_COCOALIB_FUNCTION1(PrimitiveRoot, INT) // JAA
DECLARE_COCOALIB_FUNCTION1(IsPowerOf2, INT) // JAA
...
DECLARE_COCOALIBFORC5_FUNCTION1(CatalanNumber, INT)
...
DECLARE_COCOALIB_FUNCTION1(IsPalindromic, RINGELEM)  // JAA
DECLARE_COCOALIB_FUNCTION1(IsInvertible, RINGELEM)
DECLARE_COCOALIB_FUNCTION1(IsIrred, RINGELEM)
DECLARE_COCOALIB_FUNCTION1(IsPrimitivePoly, RINGELEM)
...
DECLARE_COCOALIB_FUNCTION1(CyclotomicFactors, RINGELEM) // JAA 2023-03-15
DECLARE_COCOALIB_FUNCTION1(CyclotomicFactors_BeukersSmyth, RINGELEM) // JAA 2023-03-15
DECLARE_COCOALIB_FUNCTION1(CyclotomicFactorIndices, RINGELEM) // JAA 2023-03-15
...
//// tmp DECLARE_COCOALIB_FUNCTION3(CharPolyQuot, RINGELEM, IDEAL, RINGELEM)
...
DECLARE_COCOALIB_FUNCTION2(CoprimeFactor, INT, INT) // JAA 2023-02-27
DECLARE_COCOALIBFORC5_FUNCTION1(FactorINT, INT)
// 2023-12-22  DECLARE_COCOALIBFORC5_FUNCTION2(FactorINT_timeout, INT, INT)
DECLARE_COCOALIBFORC5_FUNCTION2(FactorINT_TrialDiv, INT, INT)
DECLARE_COCOALIBFORC5_FUNCTION2(FactorINT_PollardRho, INT, INT)
DECLARE_COCOALIBFORC5_FUNCTION1(AllFactors, INT)
DECLARE_COCOALIBFORC5_FUNCTION2(HomogCompt, RINGELEM, INT)

// Delete me if you want to (by Nico Mexis)
DECLARE_COCOALIBFORC5_FUNCTION2(GraeffeN, RINGELEM, INT)
DECLARE_COCOALIBFORC5_FUNCTION2(CyclotomicPoly, INT, RINGELEM)
DECLARE_COCOALIBFORC5_FUNCTION1(CyclotomicIndex, RINGELEM)
DECLARE_COCOALIBFORC5_FUNCTION1(CyclotomicTest, RINGELEM)
DECLARE_COCOALIBFORC5_FUNCTION1(LRSDegeneracyOrder, RINGELEM)
DECLARE_COCOALIBFORC5_FUNCTION1(LRSDegeneracyOrders, RINGELEM)
DECLARE_COCOALIBFORC5_FUNCTION2(LRSDegeneracyOrdersUnchecked, RINGELEM, INT)
DECLARE_COCOALIBFORC5_FUNCTION1(IsLRSDegenerate, RINGELEM)
DECLARE_COCOALIBFORC5_FUNCTION2(IsLRSDegenerateOrder, RINGELEM, INT)
DECLARE_COCOALIBFORC5_FUNCTION1(MoebiusFn, INT)
...
DECLARE_COCOALIB_FUNCTION1(HilbertSeriesQuot_C, IDEAL) // AMB 2026-04
...
//DECLARE_COCOALIB_FUNCTION1(NumGens, IDEAL) now also for module 2019-03
DECLARE_COCOALIB_FUNCTION1(PrimaryDecomposition, IDEAL) // AMB
DECLARE_COCOALIB_FUNCTION1(ShapeLemma, IDEAL) // AMB 2018-02 [FGLM-like]
//DECLARE_COCOALIB_FUNCTION1(radical_0dim, IDEAL) // AMB 2018-03 -- rm 2019-10
//DECLARE_COCOALIB_FUNCTION1(radical, RINGELEM) // AMB 2019-10 -- also for ideal 2023-11
DECLARE_COCOALIB_FUNCTION2(FGLM, RING, IDEAL) // AMB+EL 2024-05
...
DECLARE_COCOALIB_FUNCTION2(saturate, IDEAL, IDEAL) // AMB-2024-03 oneliner
...
DECLARE_COCOALIB_FUNCTION1(HilbertNumQuot_C, IDEAL) // AMB
