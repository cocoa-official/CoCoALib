...
namespace CoCoA
{
  ...
  namespace // anonymous
  {
    ...
    constexpr double LogZero = -1.0e15; // "minus infinity"
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/RootBound.C,v 1.22 2024/07/03 15:37:17 bigatti Exp $
// $Log: RootBound.C,v $
// Revision 1.22  2024/07/03 15:37:17  bigatti
// Summary: Specialized some ERR:BadArg with explicit error codes
//
// Revision 1.21  2024/03/08 19:59:59  abbott
// Summary: Used constexpr (redmine 1511)
//
// Revision 1.20  2023/10/05 17:55:27  abbott
// Summary: Removed some unhelpful verbose mesgs (produced way too much output)
//
