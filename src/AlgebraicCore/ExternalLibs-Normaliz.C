...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/ExternalLibs-Normaliz.C,v 1.53 2024/08/01 10:02:50 bigatti Exp $
// $Log: ExternalLibs-Normaliz.C,v $
// Revision 1.53  2024/08/01 10:02:50  bigatti
// Summary: now using CoCoA_THROW_ERROR1/2  (removing deprecated errors by string)
//
// Revision 1.52  2023/03/13 19:57:50  abbott
// Summary: Removed some cruft (lots left still)
//
