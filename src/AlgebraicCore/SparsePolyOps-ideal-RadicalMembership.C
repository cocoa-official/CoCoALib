...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/SparsePolyOps-ideal-RadicalMembership.C,v 1.8 2024/07/02 20:42:07 abbott Exp $
// $Log: SparsePolyOps-ideal-RadicalMembership.C,v $
// Revision 1.8  2024/07/02 20:42:07  abbott
// Summary: Renaming of errors (redmine 308)
//
// Revision 1.7  2024/05/28 13:07:57  bigatti
// Summary: GensForRabinovich: radical(f) uses gcd and that is currently costly.  So I disabled it.
//
// Revision 1.6  2024/03/03 21:14:09  abbott
// Summary: Fixed IsInRadical(I,J)
//
// Revision 1.5  2024/02/23 11:33:47  bigatti
// Summary: Summary: fixed x in (x^2)  Redmine #1569.11
//
// Revision 1.4  2024/02/16 15:03:11  bigatti
// Summary: added TryPowersModI if 0-dimensional and small QB
//
// Revision 1.3  2024/02/15 15:28:06  bigatti
// Summary: improved IsInRadical with single creation of
// GensForRabinovich (only if needed)
//
